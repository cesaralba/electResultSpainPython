...
fieldDescriptions = {
    ...
    "04": [
        ...
        (
            1,
            "codDistrElect",
        ),  # Distrito electoral 9 en elecciones que no tienen este tipo de circunscripción
        (
            3,
            "CMUN",
        ),  # (elecciones municipales) o del Senador (Senado). En el resto de procesos 999
        (6, "codCand"),
        (3, "numOrdenPersCand"),
    ...
    "05": [
        ...
        (
            1,
            "codDistrElect",
        ),  # Distrito electoral 0 en elecciones que no tienen este tipo de circunscripción
        (3, "codPJ"),
        (3, "codDP"),
        (3, "codCom"),  # Comarca
        (8, "pobDerecho"),
        ...
        (
            3,
            "numEscs",
        ),  # cuando el municipio es la circunscripción electoral. Ceros en otros casos
    ...
    "07": [
        ...
        (
            1,
            "codDistrElect",
        ),  # Distrito electoral 9 en datos a nivel Total Provincial, Comunidad o Nacional
        (50, "nomAmbito"),
        (8, "pobDerecho"),
        (5, "numMesas"),
        (8, "censINE"),
    ...
    "09": [
        ...
        (
            2,
            "CDIS",
        ),  # 01 si distrito único. En C.E.R.A., núm del ‘Distrito Electoral’ o 09 si provincia
        (
            4,
            "CSEC",
        ),  # (tres dígitos seguidos de un espacio, letra mayúscula u otro dígito)
        (
            1,
            "codMesa",
        ),  # (una letra mayúscula identificando la mesa o una ‘U’ en caso de mesa única)
        (7, "censINE"),
        (7, "censEscr"),
    ...
    "11": [
        (
            2,
            "tipoMunic",
        ),  # 08 = entre 100 y 250 habitantes, 09 = menores de 100 habitantes
        (4, "yearElec"),
        (2, "mesElec"),
        (1, "numVuelta"),
        (2, "CCA"),
